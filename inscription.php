            ...
            <div class="card-body p-4">
                ...
                <form method="POST">
                    <div class="mb-3">
                        ...
                        <input type="text" name="nom_complet" class="form-control" placeholder="ex: No Name" required>
                    </div>
                    <div class="mb-3">
                        <label class="form-label fw-bold">Nom d'utilisateur</label>
                        <input type="text" name="username" class="form-control" placeholder="ex: No-Name" required>
                    </div>
                    <div class="mb-3">
