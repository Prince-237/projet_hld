...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 22, 2026 at 09:04 AM
...
(3, 2, 4, '2026-03-21 14:25:46', 'En attente'),
(4, 2, 4, '2026-03-21 14:34:50', 'En attente'),
...
(1, 1, 'one', 'Medicament', 150, 190.00, 20.00),
(2, 4, 'tube edta', 'Laboratoire', 400, 310.00, 20.00);
...
(1, 1, 2, '123abc', '2026-04-30', 1500, 190.00),
(2, 1, 5, 'pr12', '2026-03-31', 730, 0.00),
(3, 2, 6, '1a', '2026-04-02', 500, 0.00);
...
--
ALTER TABLE `commandedetail`
  MODIFY `id_cmd_det` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `inventairedetail`
  MODIFY `id_inv_det` int(11) NOT NULL AUTO_INCREMENT;
